...
// Auth information
global.pairNumber = "+22879652652";                         // Add your paining number with country code example "916297175943"; 
...
global.github = "https://github.com/Htker/A17";
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["+22870097715", "+22879652652"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["+22870097715", "+22879652652"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["+22879652652"];
